...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../bootstrap-3.3.7-dist/css/sTYLE.css" rel="stylesheet" />ss
  ...
  <div id="nofuel" class="modal fade" role="dialog">
        ...
        <div class="modal-dialog">
            ...
            <div class="well wellOveride">
                 <div class="col-lg-12 col-lg-12 col-lg-12 col-lg-12 text-right">
                    <asp:LinkButton ID="LinkButton5" OnClick="removeModal" Style="color: #68213A;font-size:20px;" runat="server"><i class="glyphicon glyphicon-remove-sign"></i></asp:LinkButton>
                </div>
    ...
    <div class="footer text-center">
            ...
            <div class="hover">
                ...
                <asp:LinkButton class="social-link" ID="LinkButton4"  runat="server" OnClick="submitdiesl">&nbsp
                    <asp:Image ID="Image6" runat="server" ImageUrl="~/Images/Diesel.png" Style="height: 40px; width: 40px;" />&nbsp&nbsp<strong>Diesel</strong></asp:LinkButton>
