        ...
        <div class="well" draggable="true" style="background-color:transparent;border:none;">
            ...
            <div class="well" style="background-color:black;opacity:0.8;border-radius:40px;">
              ...
              <div class="row text-center" style="margin-bottom:20px;">
                  <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-primary categoryselector" OnClick="LinkButton2_Click">Chebiemit</asp:LinkButton>
              </div>
                <div class="row text-center" style="margin-bottom:20px;">
                  <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-primary categoryselector" OnClick="LinkButton3_Click">Chebara</asp:LinkButton>
              </div>
                <div class="row text-center">
