<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Manage_petrol_station.aspx.cs" Inherits="Petrol_Station.Agents.Manage_petrol_station" %>
      ...
      <div class="container">
        <div class="navbar-header" style="color:white;" >
          ...
          <a class="navbar-brand" href="#" style="color:white;font-size:13px;">
              ...
              |<asp:Label ID="Label3" runat="server" Text="Station management"></asp:Label>
                  ...
                  <div  class="alert alert-info myalert text-center navbar navbar-fixed-top" style="color:#68213A;opacity:01;margin-top:50px;border-top-left-radius:0px;border-top-right-radius:0px;">
                      <div class="row">
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center" >
                             <strong>Add or delete stations</strong>
         ...
         <div class="row" style="margin-top:60px;">
                  ...
                  <div class="alert alert-info myalert text-center" style="color:#68213A;opacity:01; ">
                      <div class="row">
                                                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="color:#5B5959;font-weight:bold;font-size:15px;margin-top:15px;">
                                                         <i class="glyphicon glyphicon-calendar"></i>&nbsp <asp:Label ID="Label2" runat="server" Text="Chebiemit"></asp:Label>
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="border-left:2px solid #68213A; ">
                              <div class="row">
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-left" style="color:#5B5959;font-weight:bold;">
                                   <i class="glyphicon glyphicon-ice-lolly-tasted"></i>&nbsp <asp:Label ID="Label29" runat="server" Text="563652"></asp:Label>
                                  </div>
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-left" style="color:#5B5959;font-weight:bold;">
                                   <i class="glyphicon glyphicon-flash"></i>&nbsp <asp:Label ID="Label1" runat="server" Text="Petrol"></asp:Label>
                                  </div>
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-left" style="color:#5B5959;font-weight:bold;">
             ...
             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="alert alert-info myalert text-center" style="color:#68213A;opacity:01; ">
                      <div class="row">
                                                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="color:#5B5959;font-weight:bold;font-size:15px;margin-top:15px;">
                                                         <i class="glyphicon glyphicon-calendar"></i>&nbsp <asp:Label ID="Label4" runat="server" Text="Brian Kimutai"></asp:Label>
